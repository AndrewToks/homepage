    ...
    <div className='mb-5'>
        ...
        <div className='max-w-[1000px] ml-auto mr-auto flex gap-[10px] rounded-tl-[25px] rounded-tr-[25px] border-[1.5px] border-[#E0DAD4] text-[13px]'
         style={{fontFamily:"Space Grotesk"}}>
          ...
          <section className='gap-[20px] max-w-[400px] rounded-tr-[25px] border-l-[2px] ml-auto h-fit p-5 flex flex-col items-center border-b-[2px] bg-gradient-to-br from-white to-[#FFEDE8]'>
